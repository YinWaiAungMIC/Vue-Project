<template>
	<div class="container">
		...
		<section v-else>
		<div class="row">
			<div class="col-md-12 my-3"><h1>Your Shopping Cart</h1></div>
		</div>
		<div class="row">
			<div class="col-md-8">
			 ...
			 <div class="col-md-4">
				<ul class="list-group">
					...
					<li class="list-group-item">
						...
						<span class="float-right">{{ formattingNumber(total | currencydecimal) }} MMK MMK</span>
						
					</li>
				</ul>
				<button  class="btn btn-lg btn-success mt-2" @click="order()">Check out</button>
			</div> 
		</div>
	</section>	
</div>
